  ...
  return (
    ...
    >
      <SiteArt site={site} height="h-52" priority={priority}>
        ...
        {/* dir الخاص بالمحتوى: قد يكون النص إنجليزيًا داخل واجهة عربية */}
        <div className="absolute bottom-0 start-0 end-0 p-4" dir={contentDir}>
      ...
      <div className="space-y-3 border-t border-night-600 p-4">
        <p className="text-body text-sand-dim" dir={contentDir}>
          {site.tagline}
        </p>
