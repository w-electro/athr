export default {
  jubbah: {
    name: 'Ukiran Batu Jubbah',
    shortName: 'Jubbah',
    subtitle: 'Jabal Umm Sinman · Warisan Dunia UNESCO',
    tagline: 'Galeri terbuka tertua di Tanah Arab, berusia sepuluh ribu tahun.',
    era: '±10,000 tahun dahulu (Neolitik)',
    city: 'Jubbah, barat laut Hail',
    ticket: 'Bayaran masuk bersifat simbolik · pemandu elok ditempah lebih awal',
    story: [
      {
        heading: 'Ketika gurun masih sebuah tasik',
        body: 'Sepuluh ribu tahun dahulu Jubbah bukanlah pasir yang anda lihat hari ini, sebaliknya sebuah tasik air tawar yang terbentang di lembangan ini, dikelilingi padang hijau tempat kawanan lembu liar, oriks dan burung unta turun minum; dan di tebing tasik itulah manusia prasejarah menetap, lalu apabila dia mengangkat wajah ke dinding batu Jabal Umm Sinman, dia menemui sehelai halaman kosong yang menanti tangannya.',
      },
      {
        heading: 'Umm Sinman: gunung yang berkata-kata',
        body: 'Jabal Umm Sinman menjulang di utara kampung Jubbah bagaikan dinding batu yang gah, dan pada permukaannya terpahat ribuan susuk melalui teknik tumbuk dan gores: lelaki bertubuh jangkung dan berbahu bidang, wanita bertocang panjang, serta haiwan yang digambarkan dengan ketepatan anatomi yang mengagumkan — lembu liar bertanduk melengkung, kambing gurun, singa dan burung unta; susuk terbesar antaranya melebihi dua meter, kerana ia dipahat supaya kelihatan dari jauh, umpama satu pengisytiharan jati diri.',
      },
      {
        heading: 'Daripada gambar kepada huruf',
        body: 'Yang menjadikan Jubbah luar biasa ialah ia bukan merakam satu zaman sahaja, sebaliknya peralihan manusia daripada melukis kepada menulis; kerana di atas susuk haiwan yang lebih tua terbaca inskripsi Thamudik, Nabatea dan Arab awal yang dipahat oleh musafir yang lalu ribuan tahun kemudian — sehingga satu dinding di sini menjadi buku pelawat sedalam sepuluh milenium.',
      },
      {
        heading: 'Pengiktirafan dunia',
        body: 'Pada 2015 UNESCO menyenaraikan «seni batu di wilayah Hail» dalam Senarai Warisan Dunia, merangkumi Jabal Umm Sinman di Jubbah serta Gunung al-Manjur dan Raat di Shuwaymis; itulah tapak Saudi keempat yang masuk senarai tersebut, sekali gus pengiktirafan antarabangsa pertama bahawa Gurun Nafud pernah menjadi pentas sebuah tamadun yang lengkap.',
      },
    ],
    facts: [
      { label: 'Penyenaraian UNESCO', value: '2015' },
      { label: 'Anggaran panel', value: 'lebih 5,400 ukiran' },
      { label: 'Ukiran tertua', value: 'kira-kira 10,000 tahun' },
      { label: 'Jarak dari Hail', value: '95 km ke barat laut' },
    ],
    tips: [
      'Tibalah sebaik matahari terbit: cahaya yang condong menonjolkan kedalaman ukiran, dan hanya ketika itu ia dapat dirakam.',
      'Berjalan di atas pasir dari satu panel ke panel lain memakan masa; bawalah air dan pakailah kasut tertutup.',
      'Jangan sentuh ukiran dan jangan membasahinya supaya kelihatan jelas, kerana amalan itu merosakkan batu.',
    ],
    narration: {
      voice: 'Suara Athr — naratif janaan kecerdasan buatan',
      segments: [
        { at: 0, text: 'Selamat datang ke Jubbah. Berhentilah seketika sebelum melangkah, lalu pandanglah pasir di bawah kaki anda.' },
        { at: 11, text: 'Pasir ini dahulunya air: sepuluh ribu tahun lalu sebuah tasik air tawar terbentang di sini.' },
        { at: 23, text: 'Di sebelah kanan anda menjulang Jabal Umm Sinman; dekatilah panel pertama dan carilah dua tanduk yang melengkung.' },
        { at: 38, text: 'Itu seekor lembu liar, pupus dari Tanah Arab ribuan tahun dahulu — namun ia masih di sini.' },
        { at: 52, text: 'Angkat pandangan sedikit: susuk manusia jangkung berbahu bidang itulah tandatangan orang Jubbah.' },
        { at: 68, text: 'Perhatikan juga tulisan halus di atasnya, Thamudik dan Nabatea, yang dipahat pejalan ribuan tahun kemudian.' },
        { at: 84, text: 'Anda kini berdiri di hadapan buku pelawat terpanjang dalam sejarah. Ambillah masa anda.' },
      ],
    },
    scan: {
      matchLabel: 'Dinding batu berukir · Jabal Umm Sinman',
      evidence: [
        'Teknik tumbuk pada batu pasir gelap bersalut varnis gurun',
        'Susuk manusia jangkung berbahu bidang — gaya khas Jubbah',
        'Tulisan Thamudik menindih ukiran haiwan yang lebih tua',
      ],
    },
  },
  ...
  aja: {
    name: 'Banjaran Aja',
    shortName: 'Aja',
    subtitle: 'Banjaran granit merah · sebelah barat Hail',
    tagline: 'Sebuah gunung yang menyandang nama seorang pencinta, lalu menjadi kubu kabilah Tayy dan tuan rumah legenda mereka, Hatim.',
    era: 'Formasi geologi berusia lebih 500 juta tahun',
    city: 'Sebelah barat bandar Hail',
    ticket: 'Akses bebas · sesetengah laluan memerlukan pacuan empat roda',
    story: [
      {
        heading: 'Aja dan Salma: dua gunung dan sebuah kisah cinta',
        body: 'Kitab sejarah Arab menceritakan bahawa seorang lelaki bernama Aja mencintai seorang wanita bernama Salma; kaum mereka memisahkan keduanya, lalu keduanya melarikan diri, dikejar dan dibunuh, dan masing-masing bertukar menjadi gunung: Aja di sebelah barat Hail dan Salma di sebelah timurnya, dipisahkan dataran luas yang takkan pernah mereka lintasi. Kisah itu memang legenda, namun ia berakar sedemikian dalam sehingga kedua-dua nama itu menjadi nama geografi rasmi pada setiap peta semenanjung.',
      },
      {
        heading: 'Kubu semula jadi kabilah Tayy',
        body: 'Aja tidak pernah sekadar gunung yang indah: ia ialah kubu kabilah Tayy yang menetap di rantau ini pada kurun sebelum Islam, dan menjadikan gaung sempit serta denai curamnya sebagai kedudukan yang mustahil ditawan; dari pergunungan inilah lahirnya Hatim al-Ta’i, yang kemurahannya sehingga kini menjadi peribahasa dalam bahasa Arab, begitu juga anaknya Adi yang mengadap Nabi. Adapun nama Jabal Syammar yang masyhur kemudiannya merangkumi Aja dan Salma sekali gus.',
      },
      {
        heading: 'Granit sewarna api',
        body: 'Batuan Aja ialah granit merah jambu hingga merah tua, terbentuk lebih lima ratus juta tahun dahulu daripada magma yang menyejuk perlahan di kedalaman bumi sebelum gerakan tektonik mengangkatnya, dan penyejukan yang perlahan itulah sebabnya hablur kuarza dan feldspar kelihatan jelas dengan mata kasar; ketika matahari terbenam batuan itu memantulkan cahaya sehingga seluruh banjaran seolah-olah menyala — dan itulah saat yang dinanti para jurugambar.',
      },
      {
        heading: 'Air di jantung batu',
        body: 'Antara gaung Aja terbentang denai, lembah dan lubuk yang menakung air selepas hujan, dan di sekelilingnya terdapat dusun kurma serta perkampungan kecil yang berkurun-kurun hidup daripada air itu; berjalan di gaung ini pada waktu pagi sama sekali berbeza daripada gambaran gurun yang lazim: ada bayang yang dingin, gema antara dinding batu, serta ukiran purba yang mengejutkan anda pada sebuah bongkah batu di pertengahan jalan.',
      },
    ],
    facts: [
      { label: 'Puncak tertinggi', value: 'kira-kira 1,500 m dari aras laut' },
      { label: 'Jenis batuan', value: 'granit merah jambu dan batuan volkanik purba' },
      { label: 'Panjang banjaran', value: 'lebih 100 km' },
      { label: 'Kaitan sejarah', value: 'kabilah Tayy · Hatim al-Ta’i' },
    ],
    tips: [
      'Cahaya terbaik untuk merakam gambar ialah sejam pertama selepas matahari terbit atau sejam terakhir sebelum terbenam, ketika granit seakan membara.',
      'Sesetengah gaung memerlukan pacuan empat roda; periksalah jenis laluan sebelum memasukinya.',
      'Jangan bergantung pada liputan talian di dalam gaung — muat turunlah peta sebelum bertolak.',
    ],
    narration: {
      voice: 'Suara Athr — naratif janaan kecerdasan buatan',
      segments: [
        { at: 0, text: 'Di hadapan anda terbentang Banjaran Aja. Berhentilah di muara gaung dan pasanglah telinga: anda akan mendengar sepi yang bergema.' },
        { at: 13, text: 'Batu yang anda sentuh ialah granit merah jambu, yang menyejuk perlahan di kedalaman lima ratus juta tahun dahulu.' },
        { at: 30, text: 'Kerana itulah hablurnya sebegitu besar: usaplah tangan pada permukaannya dan anda akan merasai butiran kuarza.' },
        { at: 45, text: 'Gaung-gaung ini ialah kubu kabilah Tayy; tiada orang asing masuk tanpa penunjuk jalan daripada kalangan mereka.' },
        { at: 61, text: 'Dan dari sinilah lahirnya Hatim al-Ta’i, yang namanya menjadi sinonim kemurahan hati dalam seluruh bahasa Arab.' },
        { at: 78, text: 'Jika terdaya, tinggallah sehingga matahari terbenam: ketika itu seluruh gunung bertukar sewarna bara.' },
      ],
    },
    scan: {
      matchLabel: 'Formasi granit · banjaran Aja',
      evidence: [
        'Granit merah jambu berhablur kasar dengan luluhawa membulat',
        'Puncak bergerigi dan gaung sempit yang khas pada banjaran Aja',
        'Tumbuhan gurun yang jarang di lereng bawah',
      ],
    },
  },

  museum: {
    name: 'Muzium Wilayah Hail',
    shortName: 'Muzium',
    subtitle: 'Seluruh wilayah di bawah satu bumbung',
    tagline: 'Mulakanlah dari sini: segala yang akan anda lihat di luar dijelaskan terlebih dahulu di dalam.',
    era: 'Daripada prasejarah hingga zaman moden',
    city: 'Bandar Hail',
    ticket: 'Masuk percuma · tutup pada Jumaat pagi',
    story: [
      {
        heading: 'Mengapa bermula dari sini',
        body: 'Kesilapan yang paling kerap dilakukan pengunjung Hail ialah terus menuju Jubbah, sedangkan muzium wilayah inilah yang menghulurkan kuncinya: di sini anda melihat replika ukiran berserta tafsirannya, peta yang menunjukkan bagaimana tasik dahulu menyelimuti Nafud, serta artifak asli daripada tapak di seluruh wilayah. Selepas sejam di sini, setiap batu yang anda lihat di luar menjadi terbaca, bukan lagi sekadar corak yang mengelirukan.',
      },
      {
        heading: 'Daripada batu api kepada besi',
        body: 'Dewan muzium tersusun mengikut zaman: alat batu api daripada Zaman Batu menunjukkan bagaimana manusia pertama menghasilkan mata pisau, kemudian menyusul tembikar dan alat gangsa, seterusnya inskripsi Thamudik dan Nabatea yang dipindahkan atau disalin, sehinggalah bahagian Islam yang memaparkan Hail sebagai persinggahan utama di Darb Zubaidah, iaitu jalan haji dari Kufah ke Makkah.',
      },
      {
        heading: 'Darb Zubaidah melalui tempat ini',
        body: 'Antara pameran terpenting muzium ini ialah kisah Darb Zubaidah, jalan yang diperintahkan Zubaidah, isteri Harun al-Rasyid, agar dilengkapi untuk jemaah haji dengan kolam air, perigi dan menara yang memandu perjalanan pada waktu malam, serta tempat berehat pada jarak yang dikira; jalan inilah yang, kerana merentasi wilayah Hail, menjadikannya pusat perdagangan dan kebudayaan selama berkurun, bukan sekadar tempat lalu-lalang.',
      },
      {
        heading: 'Warisan yang hidup',
        body: 'Bahagian terakhir dikhaskan untuk warisan rakyat: teko dan peralatan kopi, pakaian bersulam, alat pertanian dan pengairan lama, serta perkakas rumah orang Hail; di sinilah menjadi jelas bahawa kemurahan Hatim al-Ta’i tidak pernah sekadar legenda sastera, sebaliknya sebuah budaya keraian yang lengkap, dengan alat dan adatnya, yang masih diamalkan di rumah-rumah Hail sehingga kini.',
      },
    ],
    facts: [
      { label: 'Bahagian', value: 'Prasejarah · Kerajaan · Islam · Warisan rakyat' },
      { label: 'Tempoh sesuai', value: '90 minit' },
      { label: 'Sesuai untuk kanak-kanak', value: 'Ya — dewan berhawa dingin, laluan pendek' },
      { label: 'Masuk', value: 'Percuma' },
    ],
    tips: [
      'Lawatilah pada hari pertama perjalanan anda: ia akan mengubah cara anda memandang segala yang lain.',
      'Pilihan yang amat baik pada waktu paling panas, kerana inilah satu-satunya tempat berhawa dingin dalam senarai ini.',
      'Tanyalah secara khusus tentang bahagian Darb Zubaidah: ramai pengunjung melaluinya tanpa perasan.',
    ],
    narration: {
      voice: 'Suara Athr — naratif janaan kecerdasan buatan',
      segments: [
        { at: 0, text: 'Selamat datang ke Muzium Wilayah Hail: inilah titik permulaan terbaik bagi perjalanan anda di rantau ini.' },
        { at: 12, text: 'Dewan pertama di sebelah kanan anda: alat batu api. Perhatikan mata yang diserpih — inilah teknologi pertama yang dikenali manusia.' },
        { at: 29, text: 'Kemudian melangkahlah ke dewan ukiran: apa yang dijelaskan di sini akan anda saksikan sebentar lagi pada batu-batu Jubbah sendiri.' },
        { at: 45, text: 'Di bahagian Islam, carilah peta Darb Zubaidah: jalan itulah yang menjelaskan kepentingan Hail.' },
        { at: 62, text: 'Dan akhirnya dewan warisan rakyat: teko kopi, pakaian, serta peralatan keraian.' },
        { at: 74, text: 'Apabila anda melangkah keluar, anda akan bersedia membaca Hail, bukan sekadar memandangnya.' },
      ],
    },
    scan: {
      matchLabel: 'Artifak pameran · Muzium Wilayah Hail',
      evidence: [
        'Pencahayaan vitrin terarah pada latar gelap',
        'Alas pameran dengan label penerangan',
