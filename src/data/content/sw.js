export default {
  jubbah: {
    name: 'Michoro ya Miamba ya Jubbah',
    shortName: 'Jubbah',
    subtitle: 'Jabal Umm Sinman · Urithi wa Dunia wa UNESCO',
    tagline: 'Jumba la sanaa la wazi kongwe kuliko yote katika Uarabuni, lenye umri wa miaka elfu kumi.',
    era: 'takriban miaka 10,000 iliyopita (Enzi Mpya ya Mawe)',
    city: 'Jubbah, kaskazini-magharibi mwa Hail',
    ticket: 'Kiingilio cha ishara · ni vyema kuweka nafasi ya mwongozaji mapema',
    story: [
      {
        heading: 'Jangwa lilipokuwa ziwa',
        body: 'Miaka elfu kumi iliyopita Jubbah halikuwa mchanga unaouona leo, bali lilikuwa ziwa la maji baridi lililotanda katika bonde hili, likizungukwa na malisho ya kijani ambako makundi ya ng’ombe-mwitu, pofu na mbuni walishuka kunywa; na ni ukingoni mwa ziwa hilo ndipo mwanadamu wa kabla ya historia alipoweka makazi, na alipoinua uso wake kuelekea kuta za mawe za Jabal Umm Sinman, alikuta ukurasa mtupu ukisubiri mkono wake.',
      },
      {
        heading: 'Umm Sinman: mlima unaozungumza',
        body: 'Jabal Umm Sinman huinuka kaskazini mwa kijiji cha Jubbah kama ukuta mkubwa wa mawe, na juu ya nyuso zake kumechongwa maelfu ya maumbo kwa mbinu ya kugonga na kukwaruza: wanaume warefu wenye mabega mapana, wanawake wenye visuko virefu, na wanyama walioonyeshwa kwa usahihi wa kimwili wa kushangaza — ng’ombe-mwitu wenye pembe zilizopinda, mbuzi wa milimani, simba na mbuni; kubwa kuliko zote kati ya maumbo haya inazidi mita mbili kwa urefu, kwa kuwa ilichongwa ionekane kutoka mbali, kama tamko la utambulisho.',
      },
      {
        heading: 'Kutoka picha hadi herufi',
        body: 'Kinachoifanya Jubbah kuwa ya kipekee ni kwamba haikuandika wakati mmoja tu, bali iliandika mabadiliko yenyewe ya mwanadamu kutoka kuchora hadi kuandika: juu ya maumbo ya wanyama ya zamani zaidi husomeka maandishi ya Kithamudi, Kinabatea na Kiarabu cha awali, yaliyochongwa na wasafiri waliopita hapo baada ya maelfu ya miaka — hivyo ukuta mmoja hapa umekuwa daftari la wageni lenye kina cha milenia kumi.',
      },
      {
        heading: 'Kutambuliwa kimataifa',
        body: 'Mwaka 2015 UNESCO iliandikisha «sanaa ya miamba katika eneo la Hail» kwenye Orodha ya Urithi wa Dunia, ikijumuisha Jabal Umm Sinman huko Jubbah pamoja na milima ya al-Manjur na Raat huko Shuwaymis; hilo lilikuwa eneo la nne la Saudia kuingia kwenye orodha hiyo, na utambuzi wa kwanza wa kimataifa kwamba jangwa la Nafud hapo zamani lilikuwa jukwaa la ustaarabu mzima.',
      },
    ],
    facts: [
      { label: 'Kuandikishwa UNESCO', value: '2015' },
      { label: 'Makadirio ya paneli', value: 'zaidi ya michoro 5,400' },
      { label: 'Michoro kongwe zaidi', value: 'takriban miaka 10,000' },
      { label: 'Umbali kutoka Hail', value: 'km 95 kaskazini-magharibi' },
    ],
    tips: [
      'Fika mara tu baada ya jua kuchomoza: mwanga wa upande huibua kina cha michoro, na ni wakati huo tu ndipo inapoonekana pichani.',
      'Kutembea mchangani kutoka paneli moja hadi nyingine huchukua muda; beba maji na uvae viatu vilivyofungwa.',
      'Usiguse michoro wala usiimwagie maji ili ionekane wazi, kwa kuwa tabia hiyo huharibu mwamba.',
    ],
    narration: {
      voice: 'Sauti ya Athr — masimulizi yaliyotengenezwa na akili bandia',
      segments: [
        { at: 0, text: 'Karibu Jubbah. Simama kitambo kabla ya kusonga mbele, na uangalie mchanga ulio chini ya miguu yako.' },
        { at: 11, text: 'Mchanga huu hapo zamani ulikuwa maji: miaka elfu kumi iliyopita ziwa la maji baridi lilitanda hapa hapa.' },
        { at: 23, text: 'Kuliani kwako umeinuka Jabal Umm Sinman; sogea kwenye paneli ya kwanza na utafute pembe mbili zilizopinda.' },
        { at: 38, text: 'Huyo ni ng’ombe-mwitu, aliyetoweka Uarabuni maelfu ya miaka iliyopita — na hata hivyo bado yuko hapa.' },
        { at: 52, text: 'Inua macho kidogo: maumbo marefu ya binadamu yenye mabega mapana ndiyo saini ya watu wa Jubbah.' },
        { at: 68, text: 'Angalia pia maandishi madogo juu yao, ya Kithamudi na Kinabatea, yaliyochongwa na wapitanjia baada ya milenia kadhaa.' },
        { at: 84, text: 'Kwa sasa umesimama mbele ya daftari la wageni refu kuliko yote katika historia. Usiwe na haraka.' },
      ],
    },
    scan: {
      matchLabel: 'Ukuta wa mwamba uliochongwa · Jabal Umm Sinman',
      evidence: [
        'Mbinu ya kugonga juu ya mchanga-mwamba mweusi wenye rangi ya jangwa',
        'Maumbo marefu ya binadamu yenye mabega mapana — mtindo mahususi wa Jubbah',
        'Maandishi ya Kithamudi yaliyopandikizwa juu ya michoro ya wanyama ya zamani zaidi',
      ],
    },
  },
  ...
  aja: {
    name: 'Milima ya Aja',
    shortName: 'Aja',
    subtitle: 'Safu ya granite nyekundu · magharibi mwa Hail',
    tagline: 'Mlima unaobeba jina la mpenzi, kisha ukawa ngome ya kabila la Tayy na mwenyeji wao maarufu, Hatim.',
    era: 'Muundo wa kijiolojia wenye zaidi ya miaka milioni 500',
    city: 'Magharibi mwa mji wa Hail',
    ticket: 'Kuingia bila kizuizi · baadhi ya njia zinahitaji gari la magurudumu manne',
    story: [
      {
        heading: 'Aja na Salma: milima miwili na hadithi ya mapenzi',
        body: 'Vitabu vya habari za Waarabu vinasimulia kwamba mwanamume aitwaye Aja alimpenda mwanamke aitwaye Salma; jamaa zao walipowatenganisha walikimbia, wakafikiwa na kuuawa, kisha kila mmoja akageuzwa mlima: Aja upande wa magharibi wa Hail na Salma upande wa mashariki, na kati yao uwanda mpana wasiouvuka kamwe. Hadithi hii ni ngano, lakini iliota mizizi kiasi kwamba majina yote mawili yakawa majina rasmi ya kijiografia katika kila ramani ya rasi hii.',
      },
      {
        heading: 'Ngome ya asili ya Tayy',
        body: 'Aja haikuwa mlima mzuri tu: ilikuwa ngome ya kabila la Tayy lililotua katika eneo hili katika karne zilizotangulia Uislamu, na likazifanya korongo zake nyembamba na njia zake ngumu kuwa maskani isiyowezekana kutekwa; kutoka milima hii alitoka Hatim al-Ta’i ambaye ukarimu wake hadi leo ni methali katika Kiarabu, na pia mwanawe Adi aliyefika mbele ya Mtume. Ama jina «Jabal Shammar» lililoenea baadaye linajumuisha Aja na Salma kwa pamoja.',
      },
      {
        heading: 'Granite yenye rangi ya moto',
        body: 'Mwamba wa Aja ni granite ya waridi hadi nyekundu iliyokolea, uliotengenezwa zaidi ya miaka milioni mia tano iliyopita kutokana na magma iliyopoa taratibu ndani ya ardhi kabla ya mienendo ya ardhi kuiinua; na kupoa huko kwa taratibu ndiko kunakofanya fuwele za kwarizi na feldspar zionekane kwa jicho tupu. Wakati wa machweo mwamba huurudisha mwanga na safu nzima huonekana kana kwamba inawaka moto — na huo ndio wakati wanaousubiri wapiga picha.',
      },
      {
        heading: 'Maji ndani ya moyo wa jiwe',
        body: 'Kati ya korongo za Aja kuna njia, mabonde na madimbwi yanayoshikilia maji baada ya mvua, na kuzizunguka kuna mashamba ya mitende na vijiji vidogo vilivyoishi kwa maji hayo kwa karne nyingi; na kutembea katika korongo hizi asubuhi ni tajriba tofauti kabisa na taswira ya kawaida ya jangwa: kuna kivuli chenye ubaridi, kuna mwangwi kati ya kuta za mawe, na kuna michoro ya kale inayokushtua juu ya jiwe katikati ya njia.',
      },
    ],
    facts: [
      { label: 'Kilele cha juu zaidi', value: 'takriban mita 1,500 juu ya usawa wa bahari' },
      { label: 'Aina ya mwamba', value: 'granite ya waridi na miamba ya volkeno ya kale' },
      { label: 'Urefu wa safu', value: 'zaidi ya km 100' },
      { label: 'Uhusiano wa kihistoria', value: 'kabila la Tayy · Hatim al-Ta’i' },
    ],
    tips: [
      'Mwanga bora wa kupiga picha ni saa ya kwanza baada ya jua kuchomoza au ya mwisho kabla ya machweo, wakati granite inapong’aa kama makaa.',
      'Baadhi ya korongo zinahitaji gari la magurudumu manne; hakiki aina ya njia kabla ya kuingia.',
      'Usitegemee mtandao ndani ya korongo — pakua ramani kabla ya kuondoka.',
    ],
    narration: {
      voice: 'Sauti ya Athr — masimulizi yaliyotengenezwa na akili bandia',
      segments: [
        { at: 0, text: 'Mbele yako imesimama Milima ya Aja. Simama kwenye mlango wa korongo na usikilize: utasikia ukimya wenye mwangwi.' },
        { at: 13, text: 'Mwamba unaougusa ni granite ya waridi, iliyopoa taratibu ndani kabisa miaka milioni mia tano iliyopita.' },
        { at: 30, text: 'Ndiyo maana fuwele zake ni kubwa hivyo: pitisha mkono juu ya uso wake nawe utahisi chembe za kwarizi.' },
        { at: 45, text: 'Korongo hizi zilikuwa ngome ya kabila la Tayy; hakuna mgeni aliyeingia bila mwongozaji kutoka miongoni mwao.' },
        { at: 61, text: 'Na kutoka hapa alitoka Hatim al-Ta’i, ambaye jina lake likawa kisawe cha ukarimu katika lugha nzima ya Kiarabu.' },
        { at: 78, text: 'Kaa hadi machweo kama unaweza: wakati huo mlima mzima huchukua rangi ya makaa yanayowaka.' },
      ],
    },
    scan: {
      matchLabel: 'Muundo wa granite · safu ya Aja',
      evidence: [
        'Granite ya waridi yenye fuwele nene na mmomonyoko wa mviringo',
        'Vilele vyenye meno na korongo nyembamba, tabia ya safu ya Aja',
        'Mimea michache ya jangwani kwenye miteremko ya chini',
      ],
    },
  },

  museum: {
    name: 'Makumbusho ya Mkoa wa Hail',
    shortName: 'Makumbusho',
    subtitle: 'Mkoa mzima chini ya paa moja',
    tagline: 'Anzia hapa: kila kitu utakachokiona nje kimefafanuliwa kwanza humu ndani.',
    era: 'Kutoka kabla ya historia hadi zama za kisasa',
    city: 'Mji wa Hail',
    ticket: 'Kuingia bure · hufungwa Ijumaa asubuhi',
    story: [
      {
        heading: 'Kwa nini uanzie hapa',
        body: 'Kosa linalofanywa zaidi na wageni wa Hail ni kwenda Jubbah kwanza, ilhali makumbusho ya mkoa ndiyo yanayokupa ufunguo: hapa unaona nakala za michoro pamoja na tafsiri zake, ramani zinazoonyesha jinsi maziwa yalivyokuwa yakifunika Nafud, na vitu halisi kutoka maeneo ya kiakiolojia ya mkoa mzima. Baada ya saa moja hapa, kila jiwe utakaloliona nje linakuwa linalosomeka, badala ya kubaki nakshi isiyoeleweka.',
      },
      {
        heading: 'Kutoka jiwe-moto hadi chuma',
        body: 'Kumbi za makumbusho hufuatana kwa mpangilio wa nyakati: vifaa vya jiwe-moto vya Enzi ya Mawe vinakuonyesha jinsi mwanadamu wa kwanza alivyotengeneza ncha kali, kisha vinafuata vyungu na vifaa vya shaba, halafu maandishi ya Kithamudi na Kinabatea yaliyohamishwa au kunakiliwa, hadi sehemu ya Kiislamu ambapo Hail hujitokeza kama kituo kikuu kwenye Darb Zubayda, ile njia ya hija iliyotoka Kufa hadi Makka.',
      },
      {
        heading: 'Darb Zubayda hupita hapa',
        body: 'Miongoni mwa yale muhimu zaidi yanayooneshwa na makumbusho ni hadithi ya Darb Zubayda, ile njia ambayo Zubayda mke wa Harun al-Rashid aliamuru iandaliwe kwa ajili ya mahujaji kwa mabwawa ya maji, visima na minara iliyowaongoza usiku, pamoja na vituo vya mapumziko kwenye umbali uliopimwa; na kupita kwa njia hii katika mkoa wa Hail ndiko kulikoufanya kuwa kitovu cha biashara na utamaduni kwa karne nyingi, si mahali pa kupitia tu.',
      },
      {
        heading: 'Urithi hai',
        body: 'Sehemu ya mwisho imetengwa kwa urithi wa kienyeji: birika na vyombo vya kahawa, mavazi yaliyodarizwa, zana za zamani za kilimo na umwagiliaji, na vifaa vya nyumba ya Hail; na hapa ndipo inapodhihirika kwamba ukarimu wa Hatim al-Ta’i haukuwa ngano ya kifasihi tu, bali ulikuwa utamaduni kamili wa ukaribishaji, wenye zana na taratibu zake, unaotekelezwa hadi leo katika nyumba za Hail.',
      },
    ],
    facts: [
      { label: 'Sehemu', value: 'Kabla ya historia · Falme · Kiislamu · Urithi wa kienyeji' },
      { label: 'Muda unaofaa', value: 'Dakika 90' },
      { label: 'Inafaa kwa watoto', value: 'Ndiyo — kumbi zenye kiyoyozi, njia fupi' },
      { label: 'Kiingilio', value: 'Bure' },
    ],
    tips: [
      'Itembelee siku ya kwanza ya safari yako: itabadilisha jinsi unavyoyaona mengine yote.',
      'Ni chaguo bora katika saa za joto kali, kwa kuwa ndipo mahali pekee penye kiyoyozi katika orodha hii.',
      'Uliza mahususi kuhusu sehemu ya Darb Zubayda: wageni wengi hupita kando yake bila kuitambua.',
    ],
    narration: {
      voice: 'Sauti ya Athr — masimulizi yaliyotengenezwa na akili bandia',
      segments: [
        { at: 0, text: 'Karibu katika Makumbusho ya Mkoa wa Hail: hapa ndipo mahali bora kuanzia safari yako katika mkoa huu.' },
        { at: 12, text: 'Ukumbi wa kwanza upande wako wa kulia ni wa vifaa vya jiwe-moto. Tazama ncha iliyochongwa — hii ndiyo teknolojia ya kwanza aliyoijua mwanadamu.' },
        { at: 29, text: 'Kisha songa hadi ukumbi wa michoro: yale yanayofafanuliwa hapa utayaona punde juu ya miamba ya Jubbah yenyewe.' },
        { at: 45, text: 'Katika sehemu ya Kiislamu, tafuta ramani ya Darb Zubayda: njia hiyo ndiyo inayoeleza umuhimu wa Hail.' },
        { at: 62, text: 'Na mwishowe ukumbi wa urithi wa kienyeji: birika za kahawa, mavazi, na zana za ukaribishaji.' },
        { at: 74, text: 'Utakapotoka nje, utakuwa tayari kuisoma Hail, si kuitazama tu.' },
      ],
    },
    scan: {
      matchLabel: 'Kitu kilichoonyeshwa · Makumbusho ya Mkoa wa Hail',
      evidence: [
        'Mwanga wa kioo cha maonyesho ulioelekezwa juu ya mandharinyuma meusi',
        'Kitako cha maonyesho chenye kibao cha maelezo',
