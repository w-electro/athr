export default {
  jubbah: {
    name: 'Cübbe Kaya Resimleri',
    shortName: 'Cübbe',
    subtitle: 'Cebel Ümmü Sinman · UNESCO Dünya Mirası',
    tagline: 'Arabistan’ın en eski açık hava galerisi; on bin yıllık.',
    era: '~10.000 yıl önce (Neolitik)',
    city: 'Cübbe, Hail’in kuzeybatısı',
    ticket: 'Sembolik giriş ücreti · rehberi önceden ayırtmanız önerilir',
    story: [
      {
        heading: 'Çöl bir göl olduğunda',
        body: 'On bin yıl önce Cübbe bugün gördüğünüz kum değildi; bu çanağa yayılan tatlı su gölüydü, çevresinde yaban sığırı, oriks ve devekuşu sürülerinin indiği yeşil çayırlar uzanırdı; ve işte o gölün kıyısına yerleşen tarih öncesi insan, başını Cebel Ümmü Sinman’ın kaya yüzeylerine kaldırdığında orada elini bekleyen boş bir sayfa buldu.',
      },
      {
        heading: 'Ümmü Sinman: konuşan dağ',
        body: 'Cebel Ümmü Sinman, Cübbe köyünün kuzeyinde devasa bir taş duvar gibi yükselir ve yüzeylerinde vurma ile kazıma tekniğiyle işlenmiş binlerce figür taşır: uzun gövdeli, geniş omuzlu erkekler, uzun örgülü kadınlar ve şaşırtıcı bir anatomik doğrulukla verilmiş hayvanlar — kıvrık boynuzlu yaban sığırları, dağ keçileri, aslanlar, devekuşları; bu figürlerin en büyüğü iki metreyi aşar, çünkü uzaktan görülsün diye kazınmıştır, âdeta bir kimlik bildirisi gibi.',
      },
      {
        heading: 'Resimden harfe',
        body: 'Cübbe’yi olağanüstü kılan, tek bir anı değil, çizimden yazıya geçişin kendisini kaydetmesidir: daha eski hayvan figürlerinin üzerinde Semudî, Nabatî ve erken Arapça yazıtlar okunur; bunları, binlerce yıl sonra oradan geçen yolcular kazımıştır — böylece tek bir duvar burada on bin yıl derinliğinde bir ziyaretçi defterine dönüşür.',
      },
      {
        heading: 'Dünya çapında tanınma',
        body: '2015 yılında UNESCO, «Hail bölgesindeki kaya sanatı»nı Dünya Mirası Listesi’ne aldı; listeye Cübbe’deki Cebel Ümmü Sinman ile Şüveymis’teki el-Mencûr ve Raat dağları dâhil edildi. Bu, listeye giren dördüncü Suudi alanıydı ve Nefud Çölü’nün bir zamanlar koca bir uygarlığa sahne olduğunun ilk uluslararası tanınmasıydı.',
      },
    ],
    facts: [
      { label: 'UNESCO tescili', value: '2015' },
      { label: 'Tahmini pano sayısı', value: '5.400’den fazla kazıma' },
      { label: 'En eski kazımalar', value: 'yaklaşık 10.000 yıl' },
      { label: 'Hail’e uzaklık', value: '95 km kuzeybatıda' },
    ],
    tips: [
      'Gün doğumundan hemen sonra gidin: yandan gelen ışık kazımaların derinliğini ortaya çıkarır ve ancak o zaman fotoğraflanabilir olurlar.',
      'Panolar arasında kumda yürümek zaman alır; yanınıza su alın ve kapalı ayakkabı giyin.',
      'Kazımalara dokunmayın ve kontrastı artırmak için ıslatmayın; bu alışkanlık kayaya zarar verir.',
    ],
    narration: {
      voice: 'Athr’ın sesi — yapay zekâ ile üretilen anlatım',
      segments: [
        { at: 0, text: 'Cübbe’ye hoş geldiniz. İlerlemeden önce bir an durun ve ayaklarınızın altındaki kuma bakın.' },
        { at: 11, text: 'Bu kum bir zamanlar suydu: on bin yıl önce burada tatlı su gölü uzanıyordu.' },
        { at: 23, text: 'Sağınızda Cebel Ümmü Sinman yükseliyor; ilk panoya yaklaşın ve kıvrık iki boynuz arayın.' },
        { at: 38, text: 'Bu bir yaban sığırı; Arabistan’da binlerce yıl önce tükendi, yine de hâlâ burada.' },
        { at: 52, text: 'Bakışınızı biraz yukarı kaldırın: geniş omuzlu, uzun insan figürleri Cübbe halkının imzasıdır.' },
        { at: 68, text: 'Üstlerindeki küçük yazıya da dikkat edin: Semudî ve Nabatî; binyıllar sonra geçen yolcular kazımış.' },
        { at: 84, text: 'Tarihin en uzun ziyaretçi defterinin önündesiniz. Acele etmeyin.' },
      ],
    },
    scan: {
      matchLabel: 'Kazımalı kaya yüzeyi · Cebel Ümmü Sinman',
      evidence: [
        'Çöl cilası taşıyan koyu kumtaşı üzerinde vurma tekniği',
        'Geniş omuzlu, uzun insan figürleri — Cübbe’ye özgü üslup',
        'Daha eski hayvan kazımalarının üzerine binmiş Semudî yazı',
      ],
    },
  },
  ...
  aarif: {
    ...
    narration: {
      voice: 'Athr’ın sesi — yapay zekâ ile üretilen anlatım',
      segments: [
        { at: 0, text: 'Aarif tepesinin eteğindesiniz. Merdiven önünüzde ve yetmiş basamak sizi Hail’in en güzel manzarasından ayırıyor.' },
  ...
  aja: {
    name: 'Aca Dağları',
    shortName: 'Aca',
    subtitle: 'Kızıl granit sırası · Hail’in batısı',
    tagline: 'Bir âşığın adını taşıyan, sonra Tay kabilesinin ve efsanevi cömerdi Hâtem’in kalesi olan dağ.',
    era: '500 milyon yılı aşkın jeolojik oluşum',
    city: 'Hail şehrinin batısı',
    ticket: 'Serbest giriş · bazı yollar dört çeker gerektirir',
    story: [
      {
        heading: 'Aca ve Selma: iki dağ ve bir aşk hikâyesi',
        body: 'Arap kaynakları, Aca adında bir adamın Selma adında bir kadını sevdiğini anlatır; kavimleri onları ayırınca kaçmışlar, yakalanıp öldürülmüşler ve her biri bir dağa dönüşmüş: Aca Hail’in batısında, Selma doğusunda; aralarında hiçbir zaman aşamayacakları geniş bir ova. Hikâye bir efsanedir, ama öyle kök salmıştır ki her iki ad da yarımadanın bütün haritalarında resmî coğrafi adlar hâline gelmiştir.',
      },
      {
        heading: 'Tay’ın doğal kalesi',
        body: 'Aca hiçbir zaman yalnızca güzel bir dağ olmadı: İslam’dan önceki yüzyıllarda bölgeye yerleşen Tay kabilesinin kalesiydi ve dar boğazlarını, çetin geçitlerini zapt edilemez bir mevkiye çevirmişti. Cömertliği bugün bile Arapçada atasözü olan Hâtem et-Tâî bu dağlardan çıktı; Peygamber’in huzuruna varan oğlu Adiy de öyle. Sonradan yaygınlaşan Cebel Şammar adı ise Aca ile Selma’yı birlikte kapsar.',
      },
      {
        heading: 'Ateş renginde granit',
        body: 'Aca’nın kayası pembeden koyu kırmızıya çalan granittir; beş yüz milyon yıldan fazla bir süre önce, derinlerde yavaşça soğuyan magmadan oluşmuş, ardından yer hareketleriyle yükselmiştir ve kuvars ile feldispat kristallerinin çıplak gözle seçilebilmesinin nedeni tam da bu yavaş soğumadır. Gün batımında kaya ışığı geri verir ve bütün sıra tutuşuyormuş gibi görünür — fotoğrafçıların beklediği an işte budur.',
      },
      {
        heading: 'Taşın kalbinde su',
        body: 'Aca’nın boğazları arasında patikalar, vadiler ve yağmurdan sonra su tutan göletler uzanır; çevrelerinde ise yüzyıllarca bu sularla yaşamış hurmalıklar ve küçük köyler vardır. Bu boğazlarda sabah yürümek, çölün alışılmış imgesine hiç benzemez: serin bir gölge, taş duvarlar arasında yankı ve yolun ortasında bir kayada sizi şaşırtan eski kazımalar bulursunuz.',
      },
    ],
    facts: [
      { label: 'En yüksek zirve', value: 'yaklaşık 1.500 m rakım' },
      { label: 'Kaya türü', value: 'pembe granit ve eski volkanikler' },
      { label: 'Uzunluk', value: '100 km’den fazla' },
      { label: 'Tarihî bağ', value: 'Tay kabilesi · Hâtem et-Tâî' },
    ],
    tips: [
      'Fotoğraf için en iyi ışık: gün doğumundan sonraki ilk saat ya da gün batımından önceki son saat; granit o vakit kor gibi parlar.',
      'Bazı boğazlar dört çeker ister; girmeden önce yolun türünü kontrol edin.',
      'Boğazların içinde şebekeye güvenmeyin — yola çıkmadan haritayı indirin.',
    ],
    narration: {
      voice: 'Athr’ın sesi — yapay zekâ ile üretilen anlatım',
      segments: [
        { at: 0, text: 'Önünüzde Aca Dağları yükseliyor. Boğazın girişinde durup kulak verin: yankısı olan bir sessizlik duyacaksınız.' },
        { at: 13, text: 'Dokunduğunuz kaya pembe granit; beş yüz milyon yıl önce derinlerde ağır ağır soğumuş.' },
        { at: 30, text: 'Kristallerinin bu kadar iri olmasının nedeni de bu: elinizi yüzeyde gezdirin, kuvars tanelerini hissedersiniz.' },
        { at: 45, text: 'Bu boğazlar Tay kabilesinin kalesiydi; hiçbir yabancı, onlardan bir kılavuz almadan içeri giremezdi.' },
        { at: 61, text: 'Ve buradan Hâtem et-Tâî çıktı; adı bütün Arap dilinde cömertliğin karşılığı oldu.' },
        { at: 78, text: 'Elinizden gelirse gün batımına kadar kalın: o vakit bütün dağ kor rengine bürünür.' },
      ],
    },
    scan: {
      matchLabel: 'Granit oluşum · Aca sırası',
      evidence: [
        'Küresel ayrışma gösteren iri kristalli pembe granit',
        'Aca sırasına özgü dişli zirveler ve dar boğazlar',
        'Alt yamaçlarda seyrek çöl bitki örtüsü',
      ],
    },
  },

  museum: {
    name: 'Hail Bölge Müzesi',
    shortName: 'Müze',
    subtitle: 'Bütün bölge tek bir çatı altında',
    tagline: 'Buradan başlayın: dışarıda göreceğiniz her şey önce içeride anlatılıyor.',
    era: 'Tarih öncesinden günümüze',
    city: 'Hail şehri',
    ticket: 'Giriş ücretsiz · cuma sabahları kapalı',
    story: [
      {
        heading: 'Neden buradan başlamalı',
        body: 'Hail’i ziyaret edenlerin en sık yaptığı hata önce Cübbe’ye gitmektir; oysa anahtarı size bölge müzesi verir: burada kazımaların yorumlarıyla birlikte örneklerini, göllerin bir zamanlar Nefud’u nasıl kapladığını gösteren haritaları ve bölgenin her yanındaki alanlardan gelen özgün buluntuları görürsünüz. Burada geçirilen bir saatin ardından dışarıda gördüğünüz her kaya, anlaşılmaz bir desen olmaktan çıkıp okunur hâle gelir.',
      },
      {
        heading: 'Çakmaktaşından demire',
        body: 'Müzenin salonları kronolojik ilerler: Taş Devri’ne ait çakmaktaşı aletler ilk insanların bir ağzı nasıl yaptığını gösterir, ardından çanak çömlek ve tunç aletler gelir, sonra taşınmış ya da kopyalanmış Semudî ve Nabatî yazıtlar ve nihayet Hail’in, Kûfe’den Mekke’ye uzanan hac yolu Derb-i Zübeyde üzerindeki başlıca durak olarak göründüğü İslam bölümü.',
      },
      {
        heading: 'Derb-i Zübeyde buradan geçer',
        body: 'Müzenin en önemli sunumlarından biri Derb-i Zübeyde’nin hikâyesidir: Harun Reşid’in eşi Zübeyde’nin hacılar için su havuzları, kuyular ve geceleri yol gösteren kulelerle donattığı, hesaplanmış aralıklarla konaklama durakları kurulan yol. Bu yolun Hail bölgesinden geçmesi, burayı yüzyıllar boyunca yalnızca bir geçiş yeri değil, bir ticaret ve kültür merkezi yapmıştır.',
      },
      {
        heading: 'Yaşayan miras',
        body: 'Son bölüm halk mirasına ayrılmıştır: kahve cezveleri ve takımları, işlemeli giysiler, eski tarım ve sulama aletleri ve Hail evinin eşyaları. Burada anlaşılır ki Hâtem et-Tâî’nin cömertliği yalnızca edebî bir efsane değil, kendi eşyaları ve törenleri olan eksiksiz bir konukseverlik kültürüdür ve Hail’in evlerinde bugün de sürdürülmektedir.',
      },
    ],
    facts: [
      { label: 'Bölümler', value: 'Tarih öncesi · Krallıklar · İslam · Halk mirası' },
      { label: 'İdeal ziyaret süresi', value: '90 dakika' },
      { label: 'Çocuklara uygun', value: 'Evet — klimalı salonlar, kısa güzergâh' },
      { label: 'Giriş', value: 'Ücretsiz' },
    ],
    tips: [
      'Yolculuğunuzun ilk gününde ziyaret edin: geri kalan her şeye bakışınızı değiştirecek.',
      'Günün en sıcak saatlerinde mükemmel bir seçim, çünkü bu listedeki tek klimalı yer burası.',
      'Derb-i Zübeyde bölümünü özellikle sorun: pek çok ziyaretçi fark etmeden yanından geçiyor.',
    ],
    narration: {
      voice: 'Athr’ın sesi — yapay zekâ ile üretilen anlatım',
      segments: [
        { at: 0, text: 'Hail Bölge Müzesi’ne hoş geldiniz: bölgedeki yolculuğunuz için en iyi başlangıç noktası burasıdır.' },
        { at: 12, text: 'Sağınızdaki ilk salon: çakmaktaşı aletler. Yontulmuş ağza bakın — insanın tanıdığı ilk teknoloji budur.' },
        { at: 29, text: 'Sonra kazımalar salonuna geçin: burada anlatılanı birazdan Cübbe’nin kayalarında göreceksiniz.' },
        { at: 45, text: 'İslam bölümünde Derb-i Zübeyde haritasını arayın: Hail’in önemini o yol açıklar.' },
        { at: 62, text: 'Ve son olarak halk mirası salonu: cezveler, giysiler, konukseverliğin eşyaları.' },
        { at: 74, text: 'Dışarı çıktığınızda Hail’e yalnızca bakmaya değil, onu okumaya hazır olacaksınız.' },
      ],
    },
    scan: {
      matchLabel: 'Sergilenen eser · Hail Bölge Müzesi',
      evidence: [
        'Koyu zemin üzerinde yönlendirilmiş vitrin aydınlatması',
        'Açıklama etiketli sergi kaidesi',
