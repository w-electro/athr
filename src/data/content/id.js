export default {
  jubbah: {
    name: 'Petroglif Jubbah',
    shortName: 'Jubbah',
    subtitle: 'Jabal Umm Sinman · Warisan Dunia UNESCO',
    tagline: 'Galeri terbuka tertua di Arab, berusia sepuluh ribu tahun.',
    era: '±10.000 tahun lalu (Neolitikum)',
    city: 'Jubbah, barat laut Hail',
    ticket: 'Tiket bersifat simbolis · pemandu sebaiknya dipesan lebih dahulu',
    story: [
      {
        heading: 'Ketika gurun masih berupa danau',
        body: 'Sepuluh ribu tahun lalu Jubbah bukanlah pasir yang Anda lihat hari ini, melainkan sebuah danau air tawar yang terhampar di cekungan ini, dikelilingi padang hijau tempat kawanan sapi liar, oriks, dan burung unta turun minum; dan di tepi danau itulah manusia prasejarah menetap, lalu ketika ia mengangkat wajah ke dinding batu Jabal Umm Sinman, ia menemukan selembar halaman kosong yang menanti tangannya.',
      },
      {
        heading: 'Umm Sinman: gunung yang berbicara',
        body: 'Jabal Umm Sinman menjulang di utara desa Jubbah bagai dinding batu raksasa, dan pada permukaannya terpahat ribuan sosok dengan teknik tumbuk dan gores: lelaki bertubuh jangkung dan berbahu bidang, perempuan berkepang panjang, serta hewan-hewan yang digambarkan dengan ketepatan anatomi yang mengagumkan — sapi liar bertanduk melengkung, kambing gunung, singa, dan burung unta; sosok terbesar di antaranya melampaui dua meter, sebab ia dipahat agar terlihat dari kejauhan, laksana sebuah pernyataan jati diri.',
      },
      {
        heading: 'Dari gambar menjadi huruf',
        body: 'Yang membuat Jubbah luar biasa ialah bahwa ia tidak merekam satu masa saja, melainkan peralihan manusia dari menggambar menuju menulis; sebab di atas sosok-sosok hewan yang lebih tua terbaca inskripsi Tsamudik, Nabatea, dan Arab awal yang dipahat para musafir yang lewat ribuan tahun kemudian — sehingga satu dinding di sini menjadi buku tamu sedalam sepuluh milenium.',
      },
      {
        heading: 'Pengakuan dunia',
        body: 'Pada 2015 UNESCO mencatatkan «seni cadas di wilayah Hail» dalam Daftar Warisan Dunia, mencakup Jabal Umm Sinman di Jubbah serta Gunung al-Manjur dan Raat di Shuwaymis; itulah situs Saudi keempat yang masuk daftar tersebut, sekaligus pengakuan internasional pertama bahwa Gurun Nafud pernah menjadi panggung sebuah peradaban utuh.',
      },
    ],
    facts: [
      { label: 'Pencatatan UNESCO', value: '2015' },
      { label: 'Perkiraan panel', value: 'lebih dari 5.400 pahatan' },
      { label: 'Pahatan tertua', value: 'sekitar 10.000 tahun' },
      { label: 'Jarak dari Hail', value: '95 km ke barat laut' },
    ],
    tips: [
      'Datanglah tepat setelah matahari terbit: cahaya yang menyerong menonjolkan kedalaman pahatan, dan hanya saat itulah ia tertangkap kamera.',
      'Berjalan di atas pasir dari satu panel ke panel lain memakan waktu; bawalah air dan kenakan sepatu tertutup.',
      'Jangan menyentuh pahatan dan jangan membasahinya agar tampak jelas, sebab kebiasaan itu merusak batu.',
    ],
    narration: {
      voice: 'Suara Athr — narasi hasil kecerdasan buatan',
      segments: [
        { at: 0, text: 'Selamat datang di Jubbah. Berhentilah sejenak sebelum melangkah, lalu pandangi pasir di bawah kaki Anda.' },
        { at: 11, text: 'Pasir ini dahulu adalah air: sepuluh ribu tahun lalu sebuah danau air tawar terhampar di sini.' },
        ...
        { at: 38, text: 'Itu seekor sapi liar, punah dari Arab ribuan tahun silam — namun ia masih di sini.' },
        { at: 52, text: 'Angkat pandangan sedikit: sosok manusia jangkung berbahu bidang itulah tanda tangan orang Jubbah.' },
        { at: 68, text: 'Perhatikan pula tulisan kecil di atasnya, Tsamudik dan Nabatea, yang dipahat para pejalan ribuan tahun kemudian.' },
        { at: 84, text: 'Anda kini berdiri di hadapan buku tamu terpanjang dalam sejarah. Nikmatilah perlahan.' },
      ],
    },
    scan: {
      matchLabel: 'Dinding batu berpahat · Jabal Umm Sinman',
      evidence: [
        'Teknik tumbuk pada batu pasir gelap bervernis gurun',
        'Sosok manusia jangkung berbahu bidang — gaya khas Jubbah',
        'Tulisan Tsamudik menimpa pahatan hewan yang lebih tua',
      ],
    },
  },
  ...
  aja: {
    name: 'Pegunungan Aja',
    shortName: 'Aja',
    subtitle: 'Jajaran granit merah · sebelah barat Hail',
    tagline: 'Gunung yang menyandang nama seorang pencinta, lalu menjadi benteng kabilah Tayy dan tuan rumah legendaris mereka, Hatim.',
    era: 'Formasi geologi berumur lebih dari 500 juta tahun',
    city: 'Sebelah barat Kota Hail',
    ticket: 'Akses bebas · sebagian jalur memerlukan kendaraan gardan ganda',
    story: [
      {
        heading: 'Aja dan Salma: dua gunung dan sebuah kisah cinta',
        body: 'Kitab-kitab sejarah Arab menuturkan bahwa seorang lelaki bernama Aja mencintai perempuan bernama Salma; kaum mereka memisahkan keduanya, lalu keduanya melarikan diri, tersusul, dan dibunuh, dan masing-masing berubah menjadi gunung: Aja di sebelah barat Hail dan Salma di sebelah timurnya, dipisahkan dataran luas yang takkan pernah mereka seberangi. Kisah itu memang legenda, namun ia berakar demikian dalam sehingga kedua nama itu menjadi nama geografis resmi pada setiap peta jazirah.',
      },
      {
        heading: 'Benteng alami kabilah Tayy',
        body: 'Aja tidak pernah sekadar gunung yang indah: ia adalah kubu kabilah Tayy yang menetap di wilayah ini pada abad-abad sebelum Islam, dan menjadikan ngarai sempit serta celah-celahnya yang terjal sebagai kedudukan yang mustahil ditaklukkan; dari pegunungan inilah lahir Hatim al-Ta’i, yang kedermawanannya sampai kini menjadi peribahasa dalam bahasa Arab, begitu pula putranya Adi yang menghadap Nabi. Adapun nama Jabal Syammar yang masyhur belakangan mencakup Aja dan Salma sekaligus.',
      },
      {
        heading: 'Granit sewarna api',
        body: 'Batuan Aja adalah granit merah muda hingga merah tua, terbentuk lebih dari lima ratus juta tahun lalu dari magma yang mendingin perlahan di kedalaman bumi sebelum gerak tektonik mengangkatnya, dan pendinginan yang lambat itulah sebabnya kristal kuarsa dan feldspar tampak jelas oleh mata telanjang; saat matahari terbenam batuan itu memantulkan cahaya sehingga seluruh jajaran seolah menyala — dan itulah saat yang dinanti para juru foto.',
      },
      {
        heading: 'Air di jantung batu',
        body: 'Di antara ngarai Aja terbentang jalan setapak, lembah, dan lubuk yang menahan air seusai hujan, dan di sekitarnya terdapat kebun kurma serta desa-desa kecil yang berabad-abad hidup dari air itu; berjalan di ngarai ini pada pagi hari sama sekali berbeda dari gambaran gurun yang lazim: ada bayang yang sejuk, gema di antara dinding batu, serta pahatan kuno yang mengejutkan Anda di sebuah bongkah batu di tengah jalan.',
      },
    ],
    facts: [
      { label: 'Puncak tertinggi', value: 'sekitar 1.500 m di atas permukaan laut' },
      { label: 'Jenis batuan', value: 'granit merah muda dan batuan vulkanik purba' },
      { label: 'Bentangan', value: 'lebih dari 100 km' },
      { label: 'Kaitan sejarah', value: 'kabilah Tayy · Hatim al-Ta’i' },
    ],
    tips: [
      'Cahaya terbaik untuk memotret: satu jam pertama setelah matahari terbit atau satu jam terakhir sebelum terbenam, saat granit seakan membara.',
      'Sebagian ngarai memerlukan kendaraan gardan ganda; periksalah jenis jalannya sebelum masuk.',
      'Jangan mengandalkan sinyal di dalam ngarai — unduhlah peta sebelum berangkat.',
    ],
    narration: {
      voice: 'Suara Athr — narasi hasil kecerdasan buatan',
      segments: [
        { at: 0, text: 'Di hadapan Anda menjulang Pegunungan Aja. Berhentilah di mulut ngarai dan simaklah: Anda akan mendengar sunyi yang bergema.' },
        { at: 13, text: 'Batu yang Anda sentuh adalah granit merah muda, yang mendingin perlahan di kedalaman lima ratus juta tahun lalu.' },
        { at: 30, text: 'Karena itulah kristalnya sedemikian besar: usapkan tangan pada permukaannya dan Anda akan merasakan butiran kuarsa.' },
        { at: 45, text: 'Ngarai-ngarai ini adalah benteng kabilah Tayy; tak seorang asing pun masuk tanpa penunjuk jalan dari kalangan mereka.' },
        { at: 61, text: 'Dan dari sinilah lahir Hatim al-Ta’i, yang namanya menjadi sinonim kedermawanan di seluruh bahasa Arab.' },
        { at: 78, text: 'Bila memungkinkan, bertahanlah hingga matahari terbenam: saat itu seluruh gunung berubah sewarna bara.' },
      ],
    },
    scan: {
      matchLabel: 'Formasi granit · jajaran Aja',
      evidence: [
        'Granit merah muda berkristal kasar dengan pelapukan membulat',
        'Puncak bergerigi dan ngarai sempit yang khas jajaran Aja',
  ...
  museum: {
    name: 'Museum Daerah Hail',
    shortName: 'Museum',
    subtitle: 'Seluruh wilayah dalam satu atap',
    tagline: 'Mulailah dari sini: segala yang akan Anda lihat di luar dijelaskan lebih dahulu di dalam.',
    era: 'Dari prasejarah hingga masa modern',
    city: 'Kota Hail',
    ticket: 'Masuk gratis · tutup pada Jumat pagi',
    story: [
      {
        heading: 'Mengapa memulai dari sini',
        body: 'Kesalahan yang paling sering dilakukan pengunjung Hail ialah langsung menuju Jubbah, padahal justru museum daerah inilah yang menyerahkan kuncinya: di sini Anda melihat tiruan pahatan beserta tafsirnya, peta yang menunjukkan bagaimana danau dahulu menutupi Nafud, serta benda asli dari situs-situs di seantero wilayah. Setelah satu jam di sini, setiap batu yang Anda lihat di luar menjadi terbaca, bukan lagi sekadar corak yang tak terpahami.',
      },
      {
        heading: 'Dari batu api hingga besi',
        body: 'Ruang-ruang museum tersusun menurut urutan zaman: perkakas batu api dari Zaman Batu menunjukkan bagaimana manusia pertama membuat mata pisau, lalu menyusul tembikar dan perkakas perunggu, kemudian inskripsi Tsamudik dan Nabatea yang dipindahkan atau disalin, hingga bagian Islam tempat Hail tampil sebagai perhentian utama di Darb Zubaidah, yakni jalur haji yang membentang dari Kufah ke Makkah.',
      },
      {
        heading: 'Darb Zubaidah melewati tempat ini',
        body: 'Salah satu sajian terpenting museum adalah kisah Darb Zubaidah, jalan yang diperintahkan Zubaidah, istri Harun al-Rasyid, untuk dilengkapi demi para jemaah dengan kolam air, sumur, dan menara yang memandu perjalanan pada malam hari, serta tempat singgah pada jarak yang diperhitungkan; jalan inilah yang, karena melintasi wilayah Hail, menjadikannya pusat perdagangan dan kebudayaan selama berabad-abad, bukan sekadar tempat lintasan.',
      },
      {
        heading: 'Warisan yang hidup',
        body: 'Bagian terakhir dikhususkan bagi warisan rakyat: teko dan perkakas kopi, busana bersulam, alat pertanian dan pengairan kuno, serta perabot rumah Hail; di sinilah menjadi jelas bahwa kedermawanan Hatim al-Ta’i tidak pernah sekadar legenda sastra, melainkan sebuah kebudayaan keramahan yang utuh, lengkap dengan alat dan adatnya, yang hingga kini masih dijalankan di rumah-rumah Hail.',
      },
    ],
    facts: [
      { label: 'Bagian', value: 'Prasejarah · Kerajaan · Islam · Warisan rakyat' },
      { label: 'Durasi ideal', value: '90 menit' },
      { label: 'Ramah anak', value: 'Ya — ruang berpendingin, rute pendek' },
      { label: 'Masuk', value: 'Gratis' },
    ],
    tips: [
      'Kunjungilah pada hari pertama perjalanan Anda: ia akan mengubah cara Anda memandang semua yang lain.',
      'Pilihan yang sangat baik pada jam-jam terpanas, sebab inilah satu-satunya tempat berpendingin dalam daftar ini.',
      'Tanyakan secara khusus bagian Darb Zubaidah: banyak pengunjung melewatinya tanpa menyadari.',
    ],
    narration: {
      voice: 'Suara Athr — narasi hasil kecerdasan buatan',
      segments: [
        { at: 0, text: 'Selamat datang di Museum Daerah Hail: inilah titik awal terbaik bagi perjalanan Anda di wilayah ini.' },
        { at: 12, text: 'Ruang pertama di sebelah kanan Anda: perkakas batu api. Perhatikan mata yang diserpih — inilah teknologi pertama yang dikenal manusia.' },
        { at: 29, text: 'Lalu melangkahlah ke ruang pahatan: apa yang dijelaskan di sini akan Anda saksikan sebentar lagi pada batu-batu Jubbah sendiri.' },
        { at: 45, text: 'Di bagian Islam, carilah peta Darb Zubaidah: jalan itulah yang menjelaskan pentingnya Hail.' },
        { at: 62, text: 'Dan terakhir ruang warisan rakyat: teko kopi, busana, serta perkakas keramahan.' },
        { at: 74, text: 'Ketika Anda melangkah keluar, Anda akan siap membaca Hail, bukan sekadar memandangnya.' },
      ],
    },
    scan: {
      matchLabel: 'Benda pameran · Museum Daerah Hail',
      evidence: [
        'Pencahayaan vitrin terarah pada latar gelap',
        'Alas pameran dengan label penjelasan',
